...
namespace UdonSharp.Compiler.Binder
{
    internal class BinderSyntaxVisitor : CSharpSyntaxVisitor<BoundNode>
    {
        ...
        public override BoundNode VisitAssignmentExpression(AssignmentExpressionSyntax node)
        {
            ...
            {
                Symbol assignmentSymbol = GetSymbol(node.Left);
                ...
                return new BoundAssignmentExpression(node, Context, assignmentSymbol, assignmentTarget, lhsExpression, rhsExpression);
            }
        }
